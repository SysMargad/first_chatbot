...
Толгойд огноо, идэвхтэй үүргийн тоо, ажилласан цаг (`Snapshot HH:MM`) болон
уншсан хуудас харагдана. Толгойн өнгө: 🔴 шийдвэр шаардах үүрэг байна /
🟠 долоо хоногт дуусах үүрэг байна / 🟢 хэвийн.

**KPI хайрцаг (2×2)**

| Хайрцаг | Юуг тоолох |
|---|---|
| 🔴 LICENSE RISK | Хугацаа хэтэрсэн + асуудалтай төлөвтэй (Exception open · Rejected · Overdue) |
| 🟠 ACTION RISK | 30 хоногт дуусах ба ажил хараахан эхлээгүй (`Not started`) |
| 🟡 ≤ 7 ХОНОГТ | 7 хоногийн дотор дуусах |
| 🔵 EVIDENCE GAP | Нотлох баримт `Missing` эсхүл `Partial` |

**⚠️ ШИЙДВЭР ШААРДАХ · N** — LICENSE RISK-д тоологдсон үүрэг бүрийг нэрлэнэ.
Хэтэрсэн нь эхэнд. Мөр бүрд:

```
🔴 Exception open · OB-09-L02
Палеонтологи, археологи, угсаатны урьдчилсан судалгаа хийлгэж, дүгнэлт авах
XV-022954 · Дархан сүүжийн худаг · TIM

⚠️ LICENSE / SUSPENSION RISK
Зөрчил арилгагдаагүй тохиолдолд тусгай зөвшөөрлийн үйл ажиллагаанд
хязгаарлалт үүсэх эрсдэлтэй.

Owner · Ахлах геологич
```

**⏳ ОЙРТСОН ХУГАЦАА · N** — 30 хоногт дуусах үүргүүд, үлдсэн хоногоор
эрэмбэлэгдэнэ (🟠 ≤ 7 хоног, 🟡 ≤ 30 хоног). Дээр нэрлэгдсэн үүргийг
давхардуулахгүй. Доор нь **📊 ҮҮРГИЙН БҮРТГЭЛ НЭЭХ** товч.

Шийдвэр шаардах жагсаалт `MAX_EXCEPTION_ITEMS` (анхдагч 10), ойртсон
хугацааных `MAX_LIST_ITEMS` (анхдагч 5)-аар хязгаарлагдана; илүү гарвал
"…бусад N үүрэг" гэж тэмдэглэнэ.
